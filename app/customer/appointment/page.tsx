...
import { Calendar, Check, CheckCircle2, ChevronRight, Clock3, Download, FileText, MessageCircle, Navigation, Phone, RefreshCw, ShieldAlert, Star, Truck, UserRound, X } from "lucide-react";
...
const services: Array<{ id: ServiceId; label: string; category: ServiceCategory; duration: string; cost: string; icon: string; specialist: string; preparation: string[] }> = [
  { id: "inspection", label: "Annual Safety Inspection", category: "Safety", duration: "60 min", cost: "₹0 · covered", icon: "🛡️", specialist: "Safety Specialist", preparation: ["Keep meter and kitchen access clear", "Ensure an adult is present", "Keep appliance controls accessible"] },
  { id: "stove", label: "Gas Stove Issue", category: "Appliance", duration: "60 min", cost: "₹300 – ₹700 if parts are needed", icon: "🍳", specialist: "Appliance Technician", preparation: ["Turn off the stove and isolation valve", "Keep the stove area clear", "Do not attempt a repair yourself"] },
  { id: "geyser", label: "PNG Geyser Issue", category: "Appliance", duration: "75 min", cost: "₹300 – ₹700 if parts are needed", icon: "🚿", specialist: "Appliance Technician", preparation: ["Switch off the geyser", "Keep the bathroom accessible", "Share any error code with the engineer"] },
  { id: "pressure", label: "Low Pressure Complaint", category: "Emergency", duration: "45 min", cost: "₹0 · covered", icon: "〰️", specialist: "Network Technician", preparation: ["Note when pressure is lowest", "Keep stove knobs switched off", "Keep meter accessible"] },
  { id: "leak", label: "Gas Leakage Inspection", category: "Emergency", duration: "60 min", cost: "₹0 · safety service", icon: "⚠️", specialist: "Safety Specialist", preparation: ["Turn off the isolation valve", "Open doors and windows", "Do not use electrical switches or flames"] },
  { id: "meter", label: "Meter Check / Replacement", category: "Meter", duration: "45 min", cost: "₹0 · covered", icon: "📊", specialist: "Meter Specialist", preparation: ["Keep the meter area accessible", "Keep your last bill handy", "Ensure an adult is present"] },
  { id: "regulator", label: "Regulator Servicing", category: "Safety", duration: "30 min", cost: "₹0 · preventive service", icon: "⚙️", specialist: "Safety Specialist", preparation: ["Turn off the isolation valve", "Keep the regulator accessible", "Do not disconnect any pipe yourself"] },
  { id: "connection", label: "New Connection Setup", category: "Connection", duration: "120 min", cost: "₹0 · included in application", icon: "🔗", specialist: "Installation Specialist", preparation: ["Keep kitchen route accessible", "Keep layout approval ready", "An adult owner should be present"] },
];
...
export default function AppointmentBooking() {
  ...
  return <div className="space-y-6 reveal">
    ...
    <nav aria-label="Appointment sections" className="sticky top-3 z-10 flex gap-1 overflow-x-auto rounded-2xl border border-ink-100 bg-white/95 p-1.5 shadow-soft backdrop-blur">
