...
type Ledger = { id: string; date: string; action: string; points: number; category: string };
...
const storageKey = "suraksha:trust-points:GJ-559210";
...
export default function TrustPoints() {
  ...
  const points = useMemo(() => profile.ledger.reduce((sum, row) => sum + row.points, 0), [profile.ledger]);
